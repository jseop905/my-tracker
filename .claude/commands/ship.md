...
Follow `.claude/skills/git-workflow-and-versioning.md` for commit/branch discipline.
Use `.claude/references/security-checklist.md`, `.claude/references/performance-checklist.md`, and `.claude/references/accessibility-checklist.md` for verification.
